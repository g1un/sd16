    ...
    $.fn.SelectCustomizer = function(settings){
        ...
        return this.each(function(){
            ...
            obj.find('option').each(function(i){
                $("#"+id_slc_options).append("<div data-title=\"" + $(this).attr("value") + "\" class=\"selectitems\"><span>" + $(this).attr("label") + "</span></div>");
                if (numopts==0){
            ...
            if (numopts>1){
                        ...
                        $(document).keyup(function(e) {
                            ...
                            if(e.which == 40) {
                                ...
                                if(nextSelected.size() == 1) {
                                    ...
                                    $("#"+custom_select).val( nextSelected.data("title") );
                ...
                $("#"+id_holder+" .selectitems").click(function(){
                    ...
                    $("#"+custom_select).val(  $(this).data("title")  );
